...
const QuienesSomos = () => {
	return (
		<Container className="container-quien">
			...
			<p>
				Somos un equipo de profesionales dedicados a la gestión de hoteles, con
				amplia experiencia en mejorar la eficiencia operativa, aumentar la
				satisfacción del cliente y maximizar la rentabilidad. Nuestro equipo está
				compuesto por expertos en diversas áreas de la industria hotelera.
			</p>
			<Row>
				<Col md={3}>
					<Card>
